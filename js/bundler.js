...
class Bundler extends broccoli_plugin_1.default {
    ...
    get bundlerHook() {
        if (!this.cachedBundlerHook) {
            ...
            this.cachedBundlerHook = new webpack_1.default(this.options.bundles, this.options.environment, extraWebpackConfig, this.options.consoleWrite, this.publicAssetURL, this.skipBabel, this.options.targets, this.cachePath);
        }
